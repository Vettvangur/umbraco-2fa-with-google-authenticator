        ...
        using (var scope = scopeProvider.CreateScope(autoComplete: true))
        {
            try
            {
                ...
                if (existingAccount.Any())
                {
                    ...
                    var tf = new TwoFactor { Value = accountSecretKey, UserId = userId, Key = Constants.GoogleAuthenticatorProviderName };
                ...
                {
                    var result = scope.Database.Insert(new TwoFactor { UserId = userId, Key = Constants.GoogleAuthenticatorProviderName, Value = accountSecretKey, Confirmed = false });
